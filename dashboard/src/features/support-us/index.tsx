...
export interface SupportUsProps extends React.HTMLAttributes<HTMLDivElement> {
    donationLink: string;
    open?: boolean;
...
export const SupportUs: React.FC<SupportUsProps> = ({ open = true, variant = "status", className, structure = "card", donationLink }) => {
