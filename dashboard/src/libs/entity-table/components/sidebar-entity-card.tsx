...
export interface SidebarEntityCardSectionsProps<T> {
    header: React.FC<SidebarEntityCardSectionProps<T>>;
    content: React.FC<SidebarEntityCardSectionProps<T>>;
}

export const SidebarEntityCard: React.FC<SidebarEntityCardSectionProps<any> & SidebarEntityCardSectionsProps<any> & { checked: boolean }> = ({
