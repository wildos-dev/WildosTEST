        ...
        <div className="flex justify-between items-center p-2 w-full">
            ...
            <div className="flex justify-between items-center space-x-6 w-full lg:space-x-8">
                ...
                <div className="flex items-center space-x-2">
                    ...
                    >
                        <span className="sr-only">{t('navigation.go-to-first-page')}</span>
                    ...
                    <Button
                        ...
                        disabled={!table.getCanPreviousPage()}
                    >
                        <span className="sr-only">{t('navigation.go-to-previous-page')}</span>
                    ...
                    >
                        <span className="sr-only">{t('navigation.go-to-next-page')}</span>
                    ...
                    <Button
                        ...
                        disabled={!table.getCanNextPage()}
                    >
                        <span className="sr-only">{t('navigation.go-to-last-page')}</span>
