...
export const UserInfoTable: React.FC<UserProp> = ({ user: entity }) => {
    ...
    const lifetimeUsedTrafficByte = format(entity.lifetime_used_traffic || 0);
        ...
        <Card>
            <CardHeader className="flex flex-row justify-between items-center w-full">
                ...
                <div className="hstack justify-center items-center gap-2">
                    ...
                    >
                        <Icon name="TimerReset" className="mr-2" />
