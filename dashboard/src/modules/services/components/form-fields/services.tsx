...
const ServiceCheckboxCard: React.FC<ServiceCheckboxCardProps> = ({
    service,
    field,
}) => (
    <div
...
const ServiceSkeletons: React.FC = () => (
    <>
...
export const ServicesField: React.FC = () => {
    const form = useFormContext();
            ...
            render={() => (
                <FormItem>
                    ...
                    <Awaiting
                        ...
                        isNotFound={(data?.entities?.length || 0) === 0}
